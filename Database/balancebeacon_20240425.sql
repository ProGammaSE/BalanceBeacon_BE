...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2024 at 02:15 PM
...
(5, 12, 29, NULL, 1, 'Plan family activities or trips during breaks', 0, '2024-04-25 00:29:55'),
(6, 12, 29, NULL, 2, 'Share your academic and personal achievements to keep them involved', 0, '2024-04-25 00:29:55'),
...
--
ALTER TABLE `assessment_areas`
  MODIFY `assess_area_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=206;
...
--
ALTER TABLE `user_tips`
  MODIFY `user_tip_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=321;
COMMIT;
